...
def run_ingestion(json_file_path: str):
    ...
    for i in range(0, total_docs, batch_size):
        ...
        try:
            ...
            #  Wait 60 seconds after every batch to reset the quota
            print("⏳ Rate limit protection: Sleeping for 60 seconds...")
            time.sleep(60)
...
if __name__ == "__main__":
    run_ingestion(
        "/home/fritz-nvm/math.ai/AI_logic/curriculum_data/processed/processed_curriculum.json"
    )
